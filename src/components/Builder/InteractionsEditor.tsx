...
import { generateHTML, generatePreview } from "@/utils/previewGenerator";
        ...
        try {
            ...
            try {
                while (true) {
                    ...
                    const jsMatch = accumulatedText.match(
                        /<js>([\s\S]*?)<\/js>/,
                    );
    ...
    return (
        <div className="h-full flex flex-col gap-2 p-2">
            ...
            <div className="text-xs text-gray-400">
                <span>
                    Write custom JavaScript code that will be included in your
                    page.
                </span>
            </div>
            ...
            <div className="relative flex flex-col w-full">
                <button
                    ...
                    className={`ml-auto text-gray-400 hover:text-gray-200 transition-colors ${
                        isFullscreen ? "fixed z-[60] top-2 right-2" : "absolute top-2 right-2"
                    }`}
                    title={isFullscreen
                        ? "Exit Fullscreen"
                        : "Enter Fullscreen"}
...
document.addEventListener('DOMContentLoaded', function() {
  // Your code here
            ...
            <div className="mb-4 flex flex-col gap-2">
                ...
                <div className="text-xs text-gray-400">
                    Describe what you want the JavaScript to do, and AI will
                    generate it for you.
                </div>
