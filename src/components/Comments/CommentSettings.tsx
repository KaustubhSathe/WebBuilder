...
const CommentSettings = ({ isOpen }: CommentSettingsProps) => {
  return (
    <>
      {isOpen && (
          ...
          <div className="flex flex-col gap-2">
            ...
            <label className="flex items-center gap-2 px-2 py-1.5 hover:bg-[#3c3c3c] rounded cursor-pointer">
              <input
                ...
                className="form-checkbox bg-[#2c2c2c] border-[#4c4c4c] rounded"
              />
              <span className="text-sm text-gray-300">Only this page</span>
            </label>
            <label className="flex items-center gap-2 px-2 py-1.5 hover:bg-[#3c3c3c] rounded cursor-pointer">
              <input
                type="checkbox"
                className="form-checkbox bg-[#2c2c2c] border-[#4c4c4c] rounded"
              />
              <span className="text-sm text-gray-300">Entire project</span>
            </label>
          </div>
        </div>
      )}
