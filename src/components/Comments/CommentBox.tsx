...
const CommentBox = (
    { position, comment, onClose, onSubmit, onCancel, onResolve }:
        CommentBoxProps,
) => {
    ...
    const handleReply = async () => {
        if (
            !replyContent.trim() || !project?.id || !selectedPageId ||
            !comment?.id
        ) return;
